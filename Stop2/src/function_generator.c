...
//   f = 1000 Hz
//
static void drawScreenFrequency(double t)
{
  char freqStr[22];

  // display frequency on screen
  RETARGET_SPRINTF(freqStr, "total TIME = %f Hz", t);
...
static void drawSplash(void)
{
	...
	drawScreenText(" __________________", 20);
	drawScreenText(" FUNCTION GENERATOR", 17);
...
//
static void drawScreen(double t)
{
//  drawScreenWaveform();
  drawScreenFrequency(t);
}
...
void FunctionGenerator_main(double t)
{
	drawScreenFrequency(t);
